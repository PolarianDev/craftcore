...
PLUGIN_NAME="craftcore"  # Name of the plugin, used to remove the old plugin by checking for PLUGIN_NAME-*
PLUGIN_PATH="target/craftcore"  # Path to the compiled plugin, -* will be appended to the end when deploying
